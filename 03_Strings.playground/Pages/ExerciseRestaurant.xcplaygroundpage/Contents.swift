 ...
 */
let serverResponseToTableTwo = "Let me make sure I've got this right: \(customerOrderOne) \(customerOrderTwo) \(customerOrderThree) \(customerOrderFour) \(customerOrderFive) \(customerOrderSix)"
