...
let name = "Austin"
let age = 22
let adjective = "terrible"
let noun = "wifi"
let verb = "flipped table"
let emotion = "mad"
let wifiReportString = "\(name) was trying to connect his laptop to the \(noun) but the connection was \(adjective). That made \(name) \(emotion). So \(name) \(verb)"
